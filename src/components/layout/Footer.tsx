...
export function Footer() {
  ...
  return (
    <footer className="navbar-glass mt-0 border-t-0 rounded-none shadow-none z-10 relative">
      ...
      <div className="border-t border-[#390100]/10">
        <Container className="py-5 flex items-center justify-between text-xs text-[#390100]/50">
